...
class AutoGuiApp(tb.Window):
    ...
    def run_automation(self, DETAILS):
        ...
        COORDINATES = {
            ...
            'serviceTypeLoc': (960, 478),
            'asdLoc': (260, 881),
            'asdLoc2': (592, 184),
            'companyNameLoc': (265, 918),
            'comanyNameLoc2': (611, 184),
        ...
        def continueFormRegistaration():
            ...
            pyautogui.press("enter")
            clickAt('comanyNameLoc2', clicks=2)
            time.sleep(0.2)
        ...
        def main():
            try:
                ...
                try:
                    ...
                    # If no images found, continue with the form registration
                    continueFormRegistaration()
